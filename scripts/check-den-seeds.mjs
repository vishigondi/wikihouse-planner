...
assert(appPageSource.includes('MiniElevationPreview') && appPageSource.includes('Design') && appPageSource.includes('Brochure'), 'product gallery cards should show plan/elevation previews and quality lane chips');
assert(appPageSource.includes('onRepairPlan') && appPageSource.includes('Repair Prompt'), 'blocked product gallery cards should offer a direct GPT repair-prompt path');
assert(appPageSource.includes('Next repair:') && appPageSource.includes('firstBlockedGroup'), 'blocked product gallery cards should show the next repair target');
